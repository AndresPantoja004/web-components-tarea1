    ...
    return `
      <style>
        ...
        .background-diagonal {
          ...
          width: 100%;
          height: 100%;
          background-color: var(--bg-base, rgb(38, 114, 236));
        ...
        .title {
          font-size: 18px;
          font-weight: 700;
          color: var(--bg-base, rgb(38, 114, 236));
          margin-bottom: 8px;
        }
        ...
        .add-to-cart {
          ...
          width: 100%;
          padding: 12px;
          background: var(--bg-button, #ffc107);
          color: var(--text-color, black);
          text-align: center;
          font-weight: bold;
          border: none;
      ...
      <div class="card">
        ...
        <div class="info">
          <div class="container-secondary">
            <div class="category"><spam><slot name="category">${this.category}</slot></spam></div>
